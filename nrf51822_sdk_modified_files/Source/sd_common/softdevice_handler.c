...
#ifdef BLE_STACK_SUPPORT_REQD
    bool no_more_ble_evts = (m_ble_evt_handler.ble_evt_cb == NULL);
#endif
#ifdef ANT_STACK_SUPPORT_REQD
    ...
    for (;;)
    {
        ...
        if (!no_more_ble_evts)
        {
            ...
            else
            {
                ...
                m_ble_evt_handler.ble_evt_cb((ble_evt_t *)m_evt_buffer, m_ble_evt_handler.ble_evt_cb_payload);
            }
        }
#endif
...
{
    if (ble_evt_handler.ble_evt_cb == NULL)
    {
