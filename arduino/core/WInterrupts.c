...
extern dynamic_handler_t *dynamic_handlers;
void attachInterrupt(uint8_t IRQn, pin_callback_t callback)
{
...
{
  //RP 31/10/2014 implement it : source not provided by RFduino
