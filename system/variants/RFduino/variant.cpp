 ...
 * Pins descriptions
 */
uint8_t PPI_Channels_Occupied[PINS_COUNT][2] = {255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255};
uint8_t GPIOTE_Channels_Occupied[PINS_COUNT] = {255, 255, 255, 255, 255, 255, 255};
uint8_t Timer1_Compare_Unit_Occupied_by_Pin[3] = {255, 255, 255}; // Contains Pin number which occupied appropriate CC register (0, 1 or 2) of Timer 1 for PWM purposes
uint8_t Timer2_Compare_Unit_Occupied_by_Pin[3] = {255, 255, 255}; // Contains Pin number which occupied appropriate CC register (0, 1 or 2) of Timer 2 for PWM purposes
uint8_t Pin_Occupied_for_PWM[PINS_COUNT] = {0, 0, 0, 0, 0, 0, 0}; // Determines if particular pin is occupied for PWM output
...
void rtc_config()
{
	//Internal 32KHz synthesizer feeded by HFCLK used low frequency source clock
    NRF_CLOCK->LFCLKSRC             = (CLOCK_LFCLKSRC_SRC_Synth << CLOCK_LFCLKSRC_SRC_Pos);
    NRF_CLOCK->EVENTS_LFCLKSTARTED  = 0;
    NRF_CLOCK->TASKS_LFCLKSTART     = 1;
    while (NRF_CLOCK->EVENTS_LFCLKSTARTED == 0)
    {
        //Do nothing while clock starts
    }
    NRF_CLOCK->EVENTS_LFCLKSTARTED = 0;
